    ...
    return (
        <div style={{ padding: '32px', backgroundColor: '#f8fafc', minHeight: '100vh', boxSizing: 'border-box', fontFamily: 'Inter, system-ui, sans-serif' }}>
            ...
            <div style={{ marginBottom: '40px' }}>
                <h1 style={{ margin: 0, fontSize: '2.5rem', color: '#111827', fontWeight: '900', letterSpacing: '-1px' }}>Resource Reservation</h1>
                <p style={{ margin: '8px 0 0 0', color: '#6b7280', fontSize: '1.05rem' }}>Submit your request for academic or event space utilization.</p>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '40px', alignItems: 'start' }}>
                ...
                {/* Left Column: Form */}
                <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', border: '1px solid #f3f4f6' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                        <div style={{ width: '4px', height: '20px', backgroundColor: '#ea580c', borderRadius: '2px' }}></div>
                        <h2 style={{ margin: 0, fontSize: '1.25rem', color: '#1f2937', fontWeight: '800' }}>Request Details</h2>
                    </div>

                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                            <label style={{ fontSize: '0.85rem', fontWeight: '700', color: '#374151' }}>Resource</label>
                            <select 
                                name="resourceId" 
                                value={formData.resourceId} 
                                onChange={handleChange}
                                required
                                style={{ padding: '12px 16px', borderRadius: '8px', border: '1px solid #d1d5db', outline: 'none', fontSize: '1rem', backgroundColor: '#f9fafb', color: '#111827' }}
                            >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                            <label style={{ fontSize: '0.85rem', fontWeight: '700', color: '#374151' }}>Date</label>
                            <input 
                                type="date" 
                                name="date" 
                                value={formData.date} 
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                <label style={{ fontSize: '0.85rem', fontWeight: '700', color: '#374151' }}>Start Time</label>
                                <input 
                                    type="time" 
                                    name="startTime" 
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                <label style={{ fontSize: '0.85rem', fontWeight: '700', color: '#374151' }}>End Time</label>
                                <input 
                                    type="time" 
                                    name="endTime" 
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                            <label style={{ fontSize: '0.85rem', fontWeight: '700', color: '#374151' }}>Purpose of Request</label>
                            <textarea 
                                name="purpose" 
                                ...
                                rows="4"
                                style={{ padding: '12px 16px', borderRadius: '8px', border: '1px solid #d1d5db', outline: 'none', fontSize: '1rem', backgroundColor: '#f9fafb', color: '#111827', resize: 'vertical' }}
                            ></textarea>
                        </div>
                ...
                <div>
                    {!selectedResource ? (
                        <div style={{ 
                            backgroundColor: 'white', padding: '48px 32px', borderRadius: '16px', 
                            ...
                            <p style={{ margin: 0, fontWeight: '500' }}>Select a resource to view details</p>
                        </div>
                    ) : (
                        <div style={{ 
                            ...
                            <div style={{ 
                                ...
                                <svg width="96" height="96" fill="none" stroke="rgba(255,255,255,0.95)" viewBox="0 0 24 24">
                            ...
                            <div style={{ padding: '32px 24px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
                                    <h3 style={{ margin: 0, fontSize: '1.5rem', fontWeight: '800', color: '#0f172a', lineHeight: '1.2' }}>{selectedResource.name}</h3>
                                    <span style={{ 
                                        backgroundColor: selectedResource.status === 'AVAILABLE' ? '#dcfce7' : '#fee2e2', 
                                        color: selectedResource.status === 'AVAILABLE' ? '#15803d' : '#b91c1c', 
                                        padding: '6px 12px', borderRadius: '6px', fontSize: '0.75rem', fontWeight: '800', letterSpacing: '0.05em'
                                    }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#475569', fontSize: '1rem' }}>
                                        <div style={{ backgroundColor: '#f1f5f9', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center' }}>
                                        ...
                                        <span style={{ fontWeight: '600' }}>{selectedResource.capacity || 'Variable'} Capacity</span>
                                    </div>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#475569', fontSize: '1rem' }}>
                                        <div style={{ backgroundColor: '#f1f5f9', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center' }}>
                                        ...
                                        <span style={{ fontWeight: '500' }}>{selectedResource.location || 'Campus Wide'}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
